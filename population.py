...
import visualize
import os # added for file organization
...
class Population(object):
    ...
    def __init__(self, name, checkpoint_file=None):
        
        # added since things mess up otherwise
        ...
        if checkpoint_file:
            ...
            # added name for organizational purposes
    ...
    def epoch(self, n, report=True, save_best=False, checkpoint_interval = 10,
        ...
        for g in xrange(n):            
            ...
            if save_best:
                global BEST_CHROMO
                global BEST_CHROMO_FITNESS
                if not BEST_CHROMO:
                    BEST_CHROMO = self.best
                    BEST_CHROMO_FITNESS = self.best.fitness
                if self.best.fitness > BEST_CHROMO_FITNESS:
                    BEST_CHROMO = self.best
                    BEST_CHROMO_FITNESS = self.best.fitness
                ...
                if self.__generation == 99:
                    path = "company_chromos"
